...
import type {SymbolPaintPropsPossiblyEvaluated} from '../style/style_layer/symbol_style_layer_properties.g';
import properties from '../style/style_layer/symbol_style_layer_properties.g';
