...
import {number as mix} from '@maplibre/maplibre-gl-style-spec/util/interpolate';
import type {TerrainSpecification} from '@maplibre/maplibre-gl-style-spec/types.g';
